...
```
survival-skills3D/
├── index.html              # اللعبة كاملة في ملف واحد (كل الرسوميات إجرائية — لا أصول خارجية)
...
> 🧱 **قاعدة معمارية**: لا نماذج GLB ولا صور خامات ولا ملفات صوت — كل الرسوميات
> والمؤثرات تُولَّد برمجياً وقت التشغيل (Canvas/WebAudio)، لذا تعمل اللعبة دون اتصال بالكامل.
